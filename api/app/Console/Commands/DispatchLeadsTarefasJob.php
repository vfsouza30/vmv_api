...
use App\Jobs\ProcessLeadsTarefasPageJob;
...
class DispatchLeadsTarefasJob extends Command
{
    protected $signature = 'leads-tarefas:process';
    protected $description = 'Dispatch the ProcessLeadsTarefasPage job';
    ...
    {
        log::info('Iniciando o despacho de Leads Tarefas');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessLeadsTarefasPageJob($client);
            }
            ...
            })->name('ProcessLeadsTarefasPageJob')->dispatch();
        }
    }
}
