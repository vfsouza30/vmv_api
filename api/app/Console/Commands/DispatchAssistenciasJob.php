...
use App\Jobs\ProcessAssistenciasPageJob;
...
class DispatchAssistenciasJob extends Command
{
    protected $signature = 'assistencias:process';
    protected $description = 'Dispatch the ProcessAssistenciasPage job';
    ...
    {
        log::info('Iniciando o despacho de Assitencias');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessAssistenciasPageJob($client);
            }
            ...
            })->name('ProcessAssistenciasPageJob')->dispatch();

            foreach ($chunks_client as $client) {
                $this->workFlowService->processWorkflow($client->id, 'assistencias');
            }
        }
    }
}
