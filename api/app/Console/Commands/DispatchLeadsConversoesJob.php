...
use App\Jobs\ProcessLeadsConversoesPageJob;
...
class DispatchLeadsConversoesJob extends Command
{
    protected $signature = 'leads-conversoes:process';
    protected $description = 'Dispatch the ProcessLeadsConversoesPage job';
    ...
    {
        log::info('Iniciando o despacho de Leads Conversoes');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessLeadsConversoesPageJob($client);
            }
            ...
            })->name('ProcessLeadsConversoesPageJob')->dispatch();
        }
    }
}
