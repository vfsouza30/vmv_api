...
use App\Jobs\ProcessReservasPageJob;
...
class DispatchReservasJob extends Command
{
    protected $signature = 'reservas:process';
    protected $description = 'Dispatch the ProcessReservasPage job';
    ...
    {
        log::info('Iniciando o despacho de Reservas');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessReservasPageJob($client);
            }
            ...
            })->name('ProcessReservasPageJob')->dispatch();

            foreach ($chunks_client as $client) {
                $this->workFlowService->processWorkflow($client->id, 'reservas');
            }
        }
    }
}
