...
use App\Jobs\ProcessLeadsInteracoesPageJob;
...
class DispatchLeadsInteracoesJob extends Command
{
    protected $signature = 'leads-interacoes:process';
    protected $description = 'Dispatch the ProcessLeadsInteracoesPage job';
    ...
    {
        log::info('Iniciando o despacho de Leads Interacoes');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessLeadsInteracoesPageJob($client);
            }
            ...
            })->name('ProcessLeadsInteracoesPageJob')->dispatch();
        }
    }
}
