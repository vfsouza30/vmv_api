...
use App\Jobs\ProcessCorretoresPageJob;
...
class DispatchCorretoresJob extends Command
{
    protected $signature = 'corretores:process';
    protected $description = 'Dispatch the ProcessCorretoresPage job';
    ...
    {
        log::info('Iniciando o despacho de Corretores');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessCorretoresPageJob($client);
            }
            ...
            })->name('ProcessCorretoresPageJob')->dispatch();
        }
    }
}
