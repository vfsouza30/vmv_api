...
use App\Jobs\ProcessLeadsVisitaPageJob;
...
class DispatchLeadsVisitaJob extends Command
{
    protected $signature = 'leads-visita:process';
    protected $description = 'Dispatch the ProcessLeadsVisitaPage job';
    ...
    {
        log::info('Iniciando o despacho de Leads Visita');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessLeadsVisitaPageJob($client);
            }
            ...
            })->name('ProcessLeadsVisitaPageJob')->dispatch();
        }
    }
}
