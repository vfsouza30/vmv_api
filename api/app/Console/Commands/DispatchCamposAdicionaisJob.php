...
use App\Jobs\ProcessCamposAdicionaisPageJob;
...
class DispatchCamposAdicionaisJob extends Command
{
    protected $signature = 'campos-adicionais:process';
    protected $description = 'Dispatch the ProcessCamposAdicionaisPage job';
    ...
    {
        log::info('Iniciando o despacho de Campos Adicionais');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessCamposAdicionaisPageJob($client);
            }
            ...
            })->name('ProcessCamposAdicionaisPageJob')->dispatch();
        }
    }
}
