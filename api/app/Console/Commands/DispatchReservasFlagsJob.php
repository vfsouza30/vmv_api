...
use App\Jobs\ProcessReservasFlagsPageJob;
...
class DispatchReservasFlagsJob extends Command
{
    protected $signature = 'reservas-flags:process';
    protected $description = 'Dispatch the ProcessReservasFlagsPage job';
    ...
    {
        log::info('Iniciando o despacho de ProcessReservasFlags');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessReservasFlagsPageJob($client);
            }
            ...
            })->name('ProcessReservasFlagsPageJob')->dispatch();
        }
    }
}
