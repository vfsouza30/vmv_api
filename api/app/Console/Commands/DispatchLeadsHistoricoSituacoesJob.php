...
use App\Jobs\ProcessLeadsHistoricoSituacoesPageJob;
...
class DispatchLeadsHistoricoSituacoesJob extends Command
{
    ...
    {
        log::info('Iniciando o despacho de Process Leads Historico Situacoes');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessLeadsHistoricoSituacoesPageJob($client);
            }
            ...
            })->name('ProcessLeadsHistoricoSituacoesPageJob')->dispatch();
        }
    }
}
