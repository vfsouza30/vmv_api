...
use App\Jobs\ProcessImobiliariasPageJob;
...
class DispatchImobiliariasJob extends Command
{
    protected $signature = 'imobiliarias:process';
    protected $description = 'Dispatch the ProcessImobiliariasPage job';
    ...
    {
        log::info('Iniciando o despacho de imobiliarias');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessImobiliariasPageJob($client);
            }
            ...
            })->name('ProcessImobiliariasPageJob')->dispatch();
        }
    }
}
