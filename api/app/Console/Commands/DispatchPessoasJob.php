...
use App\Jobs\ProcessPessoasPageJob;
...
class DispatchPessoasJob extends Command
{
    protected $signature = 'pessoas:process';
    protected $description = 'Dispatch the ProcessPessoasPage job';
    ...
    {
        log::info('Iniciando o despacho de Pessoas');
        ...
        foreach ($clients->chunk(10) as $chunks_client) {
            ...
            foreach ($chunks_client as $client) {
                ...
                $jobs[] = new ProcessPessoasPageJob($client);
            }
            ...
            })->name('ProcessPessoasPageJob')->dispatch();
        }
    }
}
