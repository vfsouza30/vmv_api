...
class ProcessVendasPageJob implements ShouldQueue
{
    ...
    public function __construct($client)
    {
        ...
        $this->onQueue('process-vendas-page-job');
    }
    ...
    public function handle(): void
    {
        ...
        $urlCompleted = $this->client->url_cliente . $this->sufix_url . '/vendas';
    ...
    public function processClient($client, $urlCompleted): void
    {
        ...
        while ($page <= $totalPages) {
            ...
            for ($currentPage = $page; $currentPage <= $endPage; $currentPage++) {
                $jobs[] = new ProcessSinglePageJob($client, $urlCompleted, $currentPage, 'vendas');
            }
