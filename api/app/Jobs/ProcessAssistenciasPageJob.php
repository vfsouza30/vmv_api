...
class ProcessAssistenciasPageJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $urlCompleted = $this->client->url_cliente . $this->sufix_url . '/assistencias';
    ...
    public function processClient($client, $urlCompleted): void
    {
        ...
        while ($page <= $totalPages) {
            ...
            for ($currentPage = $page; $currentPage <= $endPage; $currentPage++) {
                $jobs[] = new ProcessSinglePageJob($client, $urlCompleted, $currentPage, 'assistencias');
            }
