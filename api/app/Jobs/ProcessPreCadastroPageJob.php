...
class ProcessPreCadastroPageJob implements ShouldQueue
{
    ...
    public function __construct($client)
    {
        ...
        $this->onQueue('process-pre-cadastro-page-job');
    }
    ...
    public function handle(): void
    {
        ...
        $urlCompleted = $this->client->url_cliente . $this->sufix_url . '/precadastros';
    ...
    public function processClient($client, $urlCompleted): void
    {
        ...
        while ($page <= $totalPages) {
            ...
            for ($currentPage = $page; $currentPage <= $endPage; $currentPage++) {
                $jobs[] = new ProcessSinglePageJob($client, $urlCompleted, $currentPage, 'preCadastro');
            }
